...
<li>Consult a doctor if deficiency persists — a multi-nutrient supplement may be recommended to bridge the gaps.</li>
        ...
        tags_ar: ['التنوع الغذائي', 'DDS', 'الجوع الخفي', 'كفاية المغذيات', 'تطوير الدماغ', 'ميزانية محدودة', 'FAO', 'تغذية الأطفال', 'الأداء الإدراكي', 'مصر 2026'],
        tags_en: ['Dietary Diversity', 'DDS', 'Hidden Hunger', 'Nutrient Adequacy', 'Brain Development', 'Limited Budget', 'FAO', 'Child Nutrition', 'Cognitive Performance', 'Egypt 2026'],
        meta: {
