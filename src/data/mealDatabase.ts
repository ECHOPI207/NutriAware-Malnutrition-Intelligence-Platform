...
export const FOOD_DB: FoodItem[] = [
    ...
    { id: 'p5', name: { en: 'Foul Medames', ar: 'فول مدمس' }, portion: { grams: 200, label: { en: '1 bowl', ar: 'طبق' } }, calories: 220, protein: 14, carbs: 32, fat: 4, fiber: 9, category: 'protein', mealSlot: ['breakfast', 'dinner'], cultural: 'middle_eastern', budget: 'low', prepTime: 'quick', allergens: [], minAgeMonths: 24, cookingMethod: 'stewed', spiceProfile: 'mild', isPlantProtein: true },
    ...
    { id: 'p7', name: { en: 'Lentil Soup', ar: 'شوربة عدس' }, portion: { grams: 250, label: { en: '1 bowl', ar: 'طبق' } }, calories: 180, protein: 12, carbs: 28, fat: 3, fiber: 8, category: 'protein', mealSlot: ['lunch', 'dinner'], cultural: 'middle_eastern', budget: 'low', prepTime: 'moderate', allergens: [], minAgeMonths: 12, cookingMethod: 'boiled', spiceProfile: 'mild', isPlantProtein: true },
    { id: 'p8', name: { en: 'Greek Yogurt', ar: 'زبادي يوناني' }, portion: { grams: 150, label: { en: '1 cup', ar: 'كوب' } }, calories: 130, protein: 15, carbs: 8, fat: 4, fiber: 0, category: 'dairy', mealSlot: ['breakfast', 'snack', 'dinner'], cultural: 'both', budget: 'moderate', prepTime: 'quick', allergens: ['dairy'], minAgeMonths: 12, spiceProfile: 'mild', isDairy: true },
    { id: 'p9', name: { en: 'Cottage Cheese', ar: 'جبنة قريش' }, portion: { grams: 100, label: { en: '½ cup', ar: 'نصف كوب' } }, calories: 98, protein: 11, carbs: 3, fat: 4, fiber: 0, category: 'dairy', mealSlot: ['breakfast', 'snack', 'dinner'], cultural: 'both', budget: 'low', prepTime: 'quick', allergens: ['dairy'], minAgeMonths: 12, spiceProfile: 'mild', isDairy: true },
    ...
    { id: 'p11', name: { en: 'White Cheese (Feta-style)', ar: 'جبنة بيضاء' }, portion: { grams: 60, label: { en: '2 slices', ar: 'شريحتين' } }, calories: 150, protein: 9, carbs: 2, fat: 12, fiber: 0, category: 'dairy', mealSlot: ['breakfast', 'dinner'], cultural: 'middle_eastern', budget: 'low', prepTime: 'quick', allergens: ['dairy'], minAgeMonths: 12, spiceProfile: 'mild', isDairy: true },
    { id: 'p12', name: { en: 'Chickpea Salad', ar: 'سلطة حمص' }, portion: { grams: 150, label: { en: '1 cup', ar: 'كوب' } }, calories: 190, protein: 10, carbs: 27, fat: 5, fiber: 7, category: 'protein', mealSlot: ['lunch', 'dinner', 'snack'], cultural: 'middle_eastern', budget: 'low', prepTime: 'quick', allergens: [], minAgeMonths: 24, spiceProfile: 'moderate', isPlantProtein: true },
    ...
    { id: 'pp1', name: { en: 'Hummus Plate', ar: 'طبق حمص' }, portion: { grams: 200, label: { en: '1 plate', ar: 'طبق' } }, calories: 250, protein: 12, carbs: 28, fat: 12, fiber: 7, category: 'protein', mealSlot: ['dinner', 'lunch'], cultural: 'middle_eastern', budget: 'low', prepTime: 'quick', allergens: [], minAgeMonths: 24, spiceProfile: 'moderate', isPlantProtein: true },
    { id: 'pp2', name: { en: 'Labneh with Vegetables', ar: 'لبنة مع خضار' }, portion: { grams: 150, label: { en: '1 bowl', ar: 'طبق' } }, calories: 160, protein: 10, carbs: 8, fat: 10, fiber: 2, category: 'dairy', mealSlot: ['dinner', 'breakfast'], cultural: 'middle_eastern', budget: 'low', prepTime: 'quick', allergens: ['dairy'], minAgeMonths: 12, spiceProfile: 'mild', isDairy: true },
    { id: 'pp3', name: { en: 'Fava Bean Stew', ar: 'يخنة فول' }, portion: { grams: 250, label: { en: '1 bowl', ar: 'طبق' } }, calories: 210, protein: 14, carbs: 30, fat: 4, fiber: 9, category: 'protein', mealSlot: ['dinner', 'lunch'], cultural: 'middle_eastern', budget: 'low', prepTime: 'moderate', allergens: [], minAgeMonths: 24, cookingMethod: 'stewed', spiceProfile: 'moderate', isPlantProtein: true },
    { id: 'pp4', name: { en: 'Yogurt Bowl with Cucumber', ar: 'طبق زبادي بالخيار' }, portion: { grams: 200, label: { en: '1 bowl', ar: 'طبق' } }, calories: 140, protein: 12, carbs: 12, fat: 5, fiber: 1, category: 'dairy', mealSlot: ['dinner', 'snack'], cultural: 'both', budget: 'low', prepTime: 'quick', allergens: ['dairy'], minAgeMonths: 12, spiceProfile: 'mild', isDairy: true },
    { id: 'pp5', name: { en: 'Mashed Bean Bowl', ar: 'طبق فول مهروس' }, portion: { grams: 200, label: { en: '1 bowl', ar: 'طبق' } }, calories: 200, protein: 13, carbs: 28, fat: 3, fiber: 8, category: 'protein', mealSlot: ['dinner'], cultural: 'middle_eastern', budget: 'low', prepTime: 'quick', allergens: [], minAgeMonths: 24, spiceProfile: 'mild', isPlantProtein: true },
    { id: 'pp6', name: { en: 'Lentil Salad', ar: 'سلطة عدس' }, portion: { grams: 200, label: { en: '1 bowl', ar: 'طبق' } }, calories: 190, protein: 11, carbs: 26, fat: 4, fiber: 7, category: 'protein', mealSlot: ['dinner', 'lunch'], cultural: 'both', budget: 'low', prepTime: 'moderate', allergens: [], minAgeMonths: 24, spiceProfile: 'mild', isPlantProtein: true },
    { id: 'pp7', name: { en: 'Cheese & Vegetable Plate', ar: 'طبق جبنة مع خضار' }, portion: { grams: 150, label: { en: '1 plate', ar: 'طبق' } }, calories: 180, protein: 12, carbs: 8, fat: 11, fiber: 3, category: 'dairy', mealSlot: ['dinner'], cultural: 'both', budget: 'moderate', prepTime: 'quick', allergens: ['dairy'], minAgeMonths: 12, spiceProfile: 'mild', isDairy: true },
    ...
    { id: 'm2', name: { en: 'Koshari', ar: 'كشري' }, portion: { grams: 300, label: { en: '1 plate', ar: 'طبق' } }, calories: 380, protein: 14, carbs: 65, fat: 6, fiber: 8, category: 'mixed', mealSlot: ['lunch'], cultural: 'middle_eastern', budget: 'low', prepTime: 'long', allergens: ['gluten'], minAgeMonths: 24, cookingMethod: 'boiled', spiceProfile: 'bold', isPlantProtein: true },
    { id: 'm3', name: { en: 'Chicken Shawarma Wrap', ar: 'شاورما دجاج لفة' }, portion: { grams: 200, label: { en: '1 wrap', ar: 'لفة واحدة' } }, calories: 350, protein: 28, carbs: 30, fat: 12, fiber: 2, category: 'mixed', mealSlot: ['lunch'], cultural: 'middle_eastern', budget: 'moderate', prepTime: 'moderate', allergens: ['gluten'], minAgeMonths: 36, cookingMethod: 'grilled', spiceProfile: 'bold' },
    { id: 'm4', name: { en: 'Stuffed Peppers', ar: 'فلفل محشي' }, portion: { grams: 250, label: { en: '2 peppers', ar: '2 فلفل' } }, calories: 280, protein: 12, carbs: 38, fat: 8, fiber: 5, category: 'mixed', mealSlot: ['lunch'], cultural: 'middle_eastern', budget: 'moderate', prepTime: 'long', allergens: [], minAgeMonths: 36, cookingMethod: 'baked', spiceProfile: 'moderate' },
    { id: 'm5', name: { en: 'Chicken Stir-Fry with Vegetables', ar: 'دجاج مقلي مع خضار' }, portion: { grams: 250, label: { en: '1 plate', ar: 'طبق' } }, calories: 300, protein: 30, carbs: 15, fat: 12, fiber: 4, category: 'mixed', mealSlot: ['lunch'], cultural: 'international', budget: 'moderate', prepTime: 'moderate', allergens: ['soy'], minAgeMonths: 24, cookingMethod: 'pan-cooked', spiceProfile: 'bold' },
