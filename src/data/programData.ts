...
export const programWeeks: ProgramWeek[] = [
    ...
    },
    {
        ...
        items: [
            ...
            { type: 'tool', id: 'meal-planner', title_ar: 'أداة تخطيط الوجبات', title_en: 'Meal Planning Tool', link: '/ai-tools', reading_time: 10 },
        ],
    ...
    },
    {
        ...
        items: [
            ...
            { type: 'tool', id: 'reassess', title_ar: 'أعد تقييم طفلك', title_en: 'Reassess Your Child', link: '/assessment' },
        ],
