                    ...
                    <CardContent className="p-8 prose dark:prose-invert max-w-none">
                        {language === 'ar' ? (
                            <div className="space-y-6 text-right" dir="rtl">
                                ...
                                <p className="text-red-500 font-semibold">تنبيه هام: المحتوى والأدوات المتوفرة على هذا الموقع هي للأغراض التعليمية والمعلوماتية فقط ولا تغني عن الاستشارة الطبية المتخصصة.</p>
                                <p>لا يجب استخدام المعلومات الواردة هنا لتشخيص أو علاج أي حالة صحية دون استشارة طبيب مختص.</p>
