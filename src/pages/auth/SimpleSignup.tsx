                    ...
                    <div className="p-8">
                        ...
                        <div className="relative mb-8">
                            ...
                            <div className="relative flex justify-center text-xs uppercase">
                                <span className="bg-transparent backdrop-blur-md px-2 text-muted-foreground">{t('auth.orSignupWithEmail')}</span>
                            </div>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div className="flex items-start gap-2">
                                ...
                                <label htmlFor="terms" className="text-sm text-muted-foreground leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">
                                    {t('auth.agreeToTerms')} <Link to="/terms" className="text-blue-600 hover:underline">{t('auth.termsOfService')}</Link> {t('common.and')} <Link to="/privacy" className="text-blue-600 hover:underline">{t('auth.privacyPolicy')}</Link>
                                </label>
                            </div>
                        ...
                        <div className="mt-8 text-center bg-transparent">
                            <p className="text-sm text-muted-foreground">
                                ...
                                <Link to="/auth/login" className="text-blue-600 font-semibold hover:text-blue-500 hover:underline transition-colors">
                                    {t('auth.signIn')}
                                </Link>
                            </p>
                        </div>
